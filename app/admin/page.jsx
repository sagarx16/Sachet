        ...
        <aside className="fixed left-0 top-16 bottom-0 w-60 bg-white border-r border-slate-200 z-30 flex flex-col justify-between py-3 shadow-sm overflow-y-auto">
          <div className="flex flex-col gap-0.5 px-2">
            ...
            <div className="px-3 py-3 mb-1 border-b border-slate-100">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-700 to-slate-900 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[18px] text-white">shield_person</span>
                </div>
                <div>
                  <div className="text-xs font-extrabold text-slate-900">Admin Desk</div>
                  <div className="text-[9px] text-slate-400 font-semibold uppercase tracking-wider">NDMA • SDMA Command</div>
                </div>
              </div>
            </div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-left text-sm font-semibold transition-all cursor-pointer ${
                    isActive
                      ? 'bg-gradient-to-r from-purple-700 to-slate-800 text-white shadow-sm'
                      : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'
                  }`}
                >
                  <span
                    className={`material-symbols-outlined text-[18px] ${isActive ? 'text-white' : colors[m.id]}`}
          ...
          <div className="px-3 pb-3 pt-3 border-t border-slate-100">
            <button
              onClick={() => setActive('broadcast')}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold text-sm shadow-md cursor-pointer transition-all"
            >
